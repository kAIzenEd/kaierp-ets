...
class SchoolAdmission(models.Model):
    ...
    class_xi_month_year = fields.Char(string='Class XI Month & Year of Completion')
    ...
    ug_non_theo_program = fields.Char(string='UG Non-Theo — Name of the Program')
    ...
    pg_theo_doctorate_seminary = fields.Char(string='Theo Doctorate — Seminary / Institution')
    pg_theo_doctorate_program = fields.Char(string='Theo Doctorate — Name of the Program')
    pg_theo_doctorate_enroll_year = fields.Char(string='Theo Doctorate — Year of Enrolment')
    pg_theo_doctorate_grad_month_year = fields.Char(string='Theo Doctorate — Month & Year of Graduation')
    pg_theo_doctorate_duration = fields.Char(string='Theo Doctorate — Duration of Study')
    pg_theo_doctorate_grade = fields.Char(string='Theo Doctorate — Grade / GPA')
    pg_non_theo_masters_program = fields.Char(string='PG Masters — Name of the Program')
    ...
    pg_non_theo_doctorate_program = fields.Char(string='PG Doctorate — Name of the Program')
